...
export const FaqSection: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-28 bg-[#050608] relative">
            ...
            return (
              <div
                ...
                className={`rounded-3xl border transition-all duration-300 overflow-hidden ${
                  isOpen
                    ? 'bg-[#0B0E14] border-[#D4AF37]/50 shadow-2xl shadow-[#D4AF37]/15'
                    : 'bg-[#0B0E14]/70 border-white/10 hover:border-white/20'
                }`}
              >
                <button
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-11 h-11 rounded-2xl flex items-center justify-center shrink-0 transition-colors ${
                        isOpen
                          ? 'bg-gradient-to-br from-[#9E822F] via-[#D4AF37] to-[#E5C158] text-slate-950 shadow-lg shadow-[#D4AF37]/25'
                    ...
                    <div>
                      <span className="text-[11px] font-mono font-bold uppercase tracking-wider text-[#D4AF37] block mb-0.5">
                        {faq.category}
                      </span>
                  ...
                  <div
                    className={`w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-slate-300 transition-transform duration-300 shrink-0 ${
                      isOpen ? 'rotate-180 bg-[#D4AF37] text-slate-950' : ''
                    }`}
                  >
                ...
                {isOpen && (
                  <div className="px-6 sm:px-7 pb-7 pt-2 border-t border-white/10 text-sm sm:text-base text-slate-300 leading-relaxed animate-in fade-in duration-200">
                    {faq.answer}
                  </div>
                )}
              </div>
