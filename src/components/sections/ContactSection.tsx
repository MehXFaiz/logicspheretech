...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-28 bg-[#050608] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="p-8 rounded-3xl bg-[#0B0E14] border border-white/10 space-y-7 shadow-2xl">
              <div>
                <span className="text-xs font-mono text-[#D4AF37] block mb-1 font-bold">
                  SILICON VALLEY & GLOBAL EDGE
                </span>
                <h3 className="text-2xl font-black text-white">Atelier Headquarters</h3>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white">San Francisco Campus</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white">Direct Executive Inbox</h4>
                  <a
                    href="mailto:contact@logicspheretech.com"
                    className="text-sm text-[#D4AF37] hover:underline mt-1 block font-mono font-bold"
                  >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white">Direct Line & WhatsApp</h4>
                  <a
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-[#050608] h-64 flex flex-col justify-between p-6">
              <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,#D4AF3720,transparent_60%),radial-gradient(ellipse_at_bottom_left,#E5C15820,transparent_60%)]" />

              <div className="relative z-10 flex items-center justify-between">
                <span className="px-3 py-1 rounded-full text-xs font-mono font-bold bg-[#D4AF37]/15 text-[#D4AF37] border border-[#D4AF37]/35 flex items-center gap-1.5">
                  <Globe className="w-3.5 h-3.5" /> Downtown SF Tech Hub
                </span>
                <span className="text-xs font-mono text-[#E5C158] font-bold flex items-center gap-1">
                  <Clock className="w-3.5 h-3.5" /> UTC-8
                </span>
              </div>

              <div className="relative z-10 flex flex-col items-center justify-center text-center my-auto">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#9E822F] via-[#D4AF37] to-[#E5C158] flex items-center justify-center shadow-xl shadow-[#D4AF37]/30 animate-bounce">
                  <MapPin className="w-7 h-7 text-slate-950" />
                </div>
                <h4 className="font-black text-white mt-3 font-mono">LOGICSPHERE ATELIER CAMPUS</h4>
          ...
          <div className="lg:col-span-7">
            <div className="p-8 sm:p-12 rounded-3xl bg-[#0B0E14] border border-white/10 shadow-2xl">
              {submitted ? (
                <div className="text-center py-16 space-y-6">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#9E822F] via-[#D4AF37] to-[#E5C158] mx-auto flex items-center justify-center shadow-xl shadow-[#D4AF37]/25">
                  ...
                  <p className="text-slate-300 max-w-md mx-auto leading-relaxed">
                    Thank you, <span className="text-[#D4AF37] font-bold">{formData.name}</span>. Our Principal Architect has received your specification and will send an initial architectural roadmap within 4 hours.
                  </p>
                  <button
                    onClick={() => {
                      setSubmitted(false);
                    ...
                    className="px-8 py-4 rounded-xl bg-gradient-to-r from-[#9E822F] via-[#D4AF37] to-[#E5C158] text-slate-950 font-black text-xs uppercase tracking-wider"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3.5 rounded-xl bg-[#050608] border text-white placeholder-slate-500 text-sm focus:outline-none transition-colors font-mono ${
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3.5 rounded-xl bg-[#050608] border text-white placeholder-slate-500 text-sm focus:outline-none transition-colors font-mono ${
                          errors.email ? 'border-rose-500' : 'border-white/10 focus:border-[#D4AF37]'
                        }`}
                      />
                      {errors.email && (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3.5 rounded-xl bg-[#050608] border border-white/10 text-white text-sm focus:outline-none focus:border-[#D4AF37] font-mono"
                      >
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#9E822F] via-[#D4AF37] to-[#E5C158] hover:opacity-95 text-slate-950 font-black text-xs uppercase tracking-wider shadow-xl shadow-[#D4AF37]/30 flex items-center justify-center gap-2 transition-all hover:scale-[1.01]"
                  >
