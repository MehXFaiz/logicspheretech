        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="relative rounded-3xl overflow-hidden border border-[#06b6d4]/35 bg-[#0f172a] shadow-2xl p-8 shadow-[#06b6d4]/15">
              ...
              <div className="flex items-center justify-between pb-6 border-b border-white/10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-white text-sm tracking-wide">LOGICSPHERE TECH</h4>
              ...
              <div className="grid grid-cols-2 gap-4 my-6">
                <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-[#06b6d4]/40 transition-colors space-y-1">
                  <span className="text-2xl sm:text-3xl font-black text-white">55+</span>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
              <strong className="text-white font-bold">LOGICSPHERE TECH</strong> is a premier software engineering atelier providing bespoke end-to-end development services. Our firm unites seasoned systems architects, AI scientists, full-stack engineers, and UI/UX masters under one private roof.
            </p>
